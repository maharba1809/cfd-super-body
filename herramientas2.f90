...
!_______________________________________________________________________
      ...
      T0=1.0
          DO k=1,nz
           DO j=1,ny
            DO i=1,nx
             u(i,j,k,1)=um1(i,j,k,2)/um1(i,j,k,1)*mask(i,j,k)
             u(i,j,k,2)=um1(i,j,k,3)/um1(i,j,k,1)*mask(i,j,k)
             u(i,j,k,3)=um1(i,j,k,4)/um1(i,j,k,1)*mask(i,j,k)
             ...
             temp(i,j,k)=(temp(i,j,k)-T0)*mask(i,j,k)+T0
